...
[_QWERTY] = { /* QWERTY */
    ...
    {KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_DQT},
    {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_ENT},
    {KC_LCTL, KC_DEL,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_BSPC, KC_RCTL}
},
[_RAISE] = { /* RAISE */
    {KB_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_MRWD, KC_MPLY, KC_MFFD, KC_MUTE, KC_VOLD, KC_VOLU, KC_POWER},
    {KC_TRNS, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KB_NO,   KB_NO,   KB_NO,   KB_NO,   KB_NO,   KB_NO,   KB_NO},
    {KC_TRNS, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KB_NO,   KB_NO,   KB_NO,   KB_NO,   KB_NO,   KB_NO,   KB_NO},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGUP, KC_TRNS, KC_STOP, KC_VOLD, KC_VOLU, KC_MUTE}
},
[_LOWER] = { /* LOWER */
    ...
    {KC_TRNS, KC_LABK, KC_RABK, KC_LBRC, KC_RBRC, KC_END,  KB_NO,   KB_NO,   KB_NO,   KB_NO,   KC_BSLS, KC_TRNS},
